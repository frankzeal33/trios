  ...
  return (
    <View className='flex-1 px-4'>
      <FlatList
        ...
        data={events}
        ListHeaderComponent={() => (
          <SearchPlaceholder placeholder='Search active events...'/>
        )}
        ...
        ListEmptyComponent={() => (
          <View>
            <View className="w-full items-center mx-auto justify-center my-6 mt-8 max-w-52 flex-1">
              ...
              <Text className="text-2xl text-center text-blue mt-4 font-ablack">No active events yet!</Text>
              <Text className="text-sm text-center text-blue mt-1 font-alight">All your active events will show here.</Text>
            </View>
          </View>
        )}
      />
