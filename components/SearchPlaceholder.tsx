...
const SearchPlaceholder = () => {
  ...
  return (
    <View className='my-3 flex-row items-center gap-1 w-full px-2'>
      <View className={`flex-1 bg-gray-tab gap-3 w-full h-12 px-4 rounded-full focus:border-purple items-center justify-center flex-row`}>
        ...
        <Pressable onPress={() => router.push("/(protected)/(routes)/(modals)/NaijaShopSearchModal")} className={`bg-dark-light flex-1 font-pregular text-base justify-center`}>
