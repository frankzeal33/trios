                ...
                <View className="flex-1 w-full items-center my-3">
                  ...
                  <View className='my-4'>
                    ...
                    <View className="flex-row gap-1 items-center justify-center mt-4">
                      <Text className="text-center text-sm font-pregular">Already have an account?</Text>
                      <TouchableOpacity onPress={() => router.push("/(user)/(auth)/Login")}>
                        <Text className="text-sm font-psbold">Log In</Text>
                      </TouchableOpacity>
                    </View>
                  </View>
                </View>
